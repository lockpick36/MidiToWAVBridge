    ...
    class TMP_Master_Fixer_Patch
    {
        static void Postfix(TextMeshProUGUI __instance)
        {
            ...
            if (objName.Equals("Version", System.StringComparison.OrdinalIgnoreCase))
            {
                ...
                UpdateTextFromLoc(__instance, "Pack_Version_Text");
            }
            ...
            else if (sceneName == "MainMenu" && objName == "Text1" && IsInCredits(__instance.transform))
            {
                ...
                if (grandParentName == "Credits_1") UpdateTextFromLoc(__instance, "Pack_Credits_1");
                else if (grandParentName == "Credits_2") UpdateTextFromLoc(__instance, "Pack_Credits_2");
                else if (grandParentName == "Credits_3") UpdateTextFromLoc(__instance, "Pack_Credits_3");
            }
